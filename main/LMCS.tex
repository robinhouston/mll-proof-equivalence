...
% It should be stressed that to consider MLL proofs modulo equivalence is a choice---one that is well motivated by semantics, but a choice nonetheless. Interesting alternatives are available, such as polarised linear logic, tensorial logic, multi-focussing, ...
...
\begin{proposition}[\cite{Blute-Cockett-Seely-Trimple-1994,Hughes-2012-nets}]
