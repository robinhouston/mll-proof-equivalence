...
%
For the `only if' direction, given a sequentialisation of $(\Gamma,\links)$, the sub-sequent of each $s(v)$ is the conclusion $\Delta, A\named v\parr B$ of its introduction rule.
\[
