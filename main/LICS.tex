...
%
\color{red} 
We will denote the empire of $v$ in $\links$ by $\emp v$.
\color{black}


\begin{proposition}[{\cite[Proposition 2.b]{Bellin-vandeWiele-1995}}]
\label{prop:empire propagation}
The empire $\emp v$ is determined by propagation from $v$: 1) through links; 2) up towards subformulae; 3) into a tensor if one of its subformulae is in $\emp v$; 4) into a par if all its subformulae are in $\emp v$; 5) except never into a par or tensor if $v$ is a subformula.
\end{proposition}
