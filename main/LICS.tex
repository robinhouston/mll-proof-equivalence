...
MLL proof equivalence may be usefully classified as the reconfiguration problem associated with MLL proof search, which is \textsc{np}-complete \cite{Lincoln-1994}.
...
\\ \\[6pt]
	\multicolumn{3}{@{}c@{}}{
		\vc{\scale{\MLLperm{bt2}}} ~\perm~ \vc{\scale{\MLLperm{bt1}}} ~\perm~ \vc{\scale{\MLLperm{bt3}}}
	}
\\ \\[6pt]
...
In one of several possible definitions, a \emph{$\star$-autonomous category} \cite{Barr-1979} is a symmetric monoidal category $(\mathcal C,\tn,1)$ with:
%
\begin{itemize}
