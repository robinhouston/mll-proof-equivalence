...
\begin{figure}[!b]
\quad\capsabbrev{mll}rule b
\hfill\capsabbrev{mll}rule 1
\hfill\capsabbrev{mll}rule p
\hfill\capsabbrev{mll}rule t
\quad
...
\begin{array}{@{}rcl@{}}
	\multicolumn{3}{@{}c@{}}{
		\vc{\scale{\capsabbrev{mll}perm{bb1}}} ~\perm~ \vc{\scale{\capsabbrev{mll}perm{bb2}}}
		\hfill
		\vc{\scale{\capsabbrev{mll}perm{bp1}}} ~\perm~ \vc{\scale{\capsabbrev{mll}perm{bp2}}}
	}
\\ \\[6pt]
	\multicolumn{3}{@{}c@{}}{
		\vc{\scale{\capsabbrev{mll}perm{bt2}}} ~\perm~ \vc{\scale{\capsabbrev{mll}perm{bt1}}}
								   ~\perm~ \vc{\scale{\capsabbrev{mll}perm{bt3}}}
	}
\\ \\[6pt]
	\vc{\scale{\capsabbrev{mll}perm{pp1}}} &\perm& \vc{\scale{\capsabbrev{mll}perm{pp2}}}
\\ \\[6pt]
	\vc{\scale{\capsabbrev{mll}perm{pt1}}} &\perm& \vc{\scale{\capsabbrev{mll}perm{pt2}}}
\\ \\[6pt]
	\vc{\scale{\capsabbrev{mll}perm{tt1}}} &\perm& \vc{\scale{\capsabbrev{mll}perm{tt2}}}
\end{array}
\]
...
\[
	\infer[\capsabbrev{mll}label b]{\Gamma,\named a\bot}{\Gamma}
\]
%
\end{definition}
...
\[
	\infer[\capsabbrev{mll}label p]{\Delta,A\named v\parr B}{\Delta,A,B}
\]
\vskip-12pt
\end{IEEEproof}
...
\emph{Non-deterministic constraint graph reconfiguration} or \emph{\capsabbrev{ncg}-reconfiguration} is the problem of deciding whether two total configurations for a constraint graph are connected by a sequence of reconfiguration steps.
%
