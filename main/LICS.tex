...
Finally, the standard notion of \emph{balance} is useful in constructing proof nets without $\parr$-connectives
...
We will demonstrate the \textsc{pspace}-hardness of MLL proof equivalence by an encoding of partial \textsc{ncg}-reconfiguration in MLL proof nets.
